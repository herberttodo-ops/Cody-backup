...
|--------|--------|-----|------------------|
| **Highly Opinionated Advice on How to Write ML Papers** | Neel Nanda | [Alignment Forum](https://www.alignmentforum.org/posts/eJGptPbbFPZGLpjsp/___LONG_STRING___) | Narrative framework, "What/Why/So What", time allocation |
...
| **Heuristics for Scientific Writing** | Zachary Lipton (CMU) | [Blog](https://www.approximatelycorrect.com/2018/01/29/___LONG_STRING___/) | Word choice, section balance, intensifier warnings |
...
|--------|-----|------------------|
| How To Write A Research Paper In ML | [Blog](https://grigorisg9gr.github.io/machine%20learning/research%20paper/___LONG_STRING___/) | Practical walkthrough, LaTeX tips |
...
| NeurIPS 2025 AI Report | [ByteIota](https://byteiota.com/___LONG_STRING___/) | 100+ hallucinated citations |
