...
all_chars.update("___LONG_STRING___ .,-:;!?/|")
...
def linear_rgb_to_oklab(r, g, b):
    ...
    l_ = 0.___ID___ * r + 0.___ID___ * g + 0.___ID___ * b
    m_ = 0.___ID___ * r + 0.___ID___ * g + 0.___ID___ * b
    s_ = 0.___ID___ * r + 0.___ID___ * g + 0.___ID___ * b
    l_c = np.cbrt(l_); m_c = np.cbrt(m_); s_c = np.cbrt(s_)
    L = 0.___ID___ * l_c + 0.___ID___ * m_c - 0.___ID___ * s_c
    a = 1.___ID___ * l_c - 2.___ID___ * m_c + 0.___ID___ * s_c
    b_ = 0.___ID___ * l_c + 0.___ID___ * m_c - 0.___ID___ * s_c
    return L, a, b_

def oklab_to_linear_rgb(L, a, b):
    """OKLAB to linear sRGB. Returns (r, g, b) float32 arrays [0,1]."""
    l_ = L + 0.___ID___ * a + 0.___ID___ * b
    m_ = L - 0.___ID___ * a - 0.___ID___ * b
    s_ = L - 0.___ID___ * a - 1.___ID___ * b
    l_c = l_ ** 3; m_c = m_ ** 3; s_c = s_ ** 3
    r = +4.___ID___ * l_c - 3.___ID___ * m_c + 0.___ID___ * s_c
    g = -1.___ID___ * l_c + 2.___ID___ * m_c - 0.___ID___ * s_c
    b_ = -0.___ID___ * l_c - 0.___ID___ * m_c + 1.___ID___ * s_c
