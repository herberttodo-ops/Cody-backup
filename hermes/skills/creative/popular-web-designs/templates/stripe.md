...
### Accent Colors
- **Ruby** (`#ea2261`): `___LONG_STRING___`. Warm red-pink for icons, alerts, and accent elements.
- **Magenta** (`#f96bee`): `___LONG_STRING___`. Vivid pink-purple for gradients and decorative highlights.
