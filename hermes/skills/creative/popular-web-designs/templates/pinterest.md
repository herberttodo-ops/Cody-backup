...
- **Warm Silver** (`#91918c`): `___LONG_STRING___`, disabled text, input borders
- **White** (`#ffffff`): Text on dark/colored surfaces

### Interactive
- **Focus Blue** (`#435ee5`): `___LONG_STRING___`, focus rings
- **Performance Purple** (`#6845ab`): `___LONG_STRING___`, performance features
...
- **Warm Wash** (`hsla(60, 20%, 98%, 0.5)`): `___LONG_STRING___`, subtle warm badge bg
