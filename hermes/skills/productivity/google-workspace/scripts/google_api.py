...
# Note: These are the preferred scopes, but the actual token may have different ones
# The _missing_scopes function will warn about missing scopes but not block execution
SCOPES = [
    "https://www.googleapis.com/auth/gmail.modify",  # Includes read and send
...
def get_credentials():
    ...
    if missing_scopes:
        print(
            "Warning: Token is missing some requested scopes, but continuing anyway.",
            file=sys.stderr,
        )
