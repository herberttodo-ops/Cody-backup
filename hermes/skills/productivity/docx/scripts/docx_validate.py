...
def validate(path: str) -> dict:
    ...
    # --- relationships resolve ___LONG_STRING___
    ...
    # --- embedded images decode ___LONG_STRING___
    ...
    # --- styles referenced exist ___LONG_STRING___
    defined = set()
    ...
    # --- python-docx can open it ___LONG_STRING___
    try:
