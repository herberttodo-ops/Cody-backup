...
**Tales Untold Short – Buffer Refill Complete**

- **TITLE:** Dracula: What the Vatican Archives Refuse to Release
- **ENTITY:** Dracula
...
- **VOICE:** ElevenLabs Adam
- **SCENES:** 6
- **DUE AT:** 2026-09-25T00:00:00.000Z (8:00 PM ET, Sep 24)
- **BUFFER POST ID:** `6ab584d2b30c30cf0f3c4c6a`
- **DRIVE URL:** https://drive.google.com/uc?export=download&id=1pefaxNOAQpJDFqCij_5NvLXv215k_a5h
- **FILE:** `output/FINAL_29_dracula_war_journal.mp4` (19.5 MB)

**Slot logic:** 4:00 PM ET run targeted the next-day 00:00 UTC slot. Buffer had 8 scheduled posts, so production proceeded. Video rendered, mixed, uploaded to Drive, and scheduled successfully. A/B variant logged.
