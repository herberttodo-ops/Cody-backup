...
**Tales Untold Buffer Refill Completed**

**TITLE:** I Tracked a Skinwalker For Three Nights. The Fourth Night, It Tracked Me  
**ENTITY:** Navajo Skinwalker  
**TIER:** 1 (Named folklore/cryptid)  
**VARIANT:** A (first-person direct hook)  
**DURATION:** 61.0s  
**VOICE:** ElevenLabs Adam  
**SCENES:** 6 (Gammell ink-wash style, 9:16)  
**FILE:** `output/FINAL_23_skinwalker_tracking.mp4` (22.9 MB, faststart)  
**UPLOAD:** https://drive.google.com/uc?export=download&id=1Oh1E6HHBQ9UG34K5CUsKIOU3h27zSbge  
**BUFFER POST ID:** `6ab3c1fe9101da39d1ffb476`  
**SCHEDULED:** September 25, 2026 at 6:00 PM ET (`2026-09-25T22:00:00Z`)

**Pipeline:**
- TTS generated via POYO (`elevenlabs-tts-turbo-2-5`)
- Whisper transcription: 12 segments
- 6 scenes rendered via POYO (`nano-banana-2-lite`, 9:16)
- HyperFrames render: 59.0s visual @ 30fps
- Audio mix: narration + `tales_track_1.mp3` @ 0.4 volume
- Re-encoded for faststart (147.9 MB → 22.9 MB)
- Uploaded to Google Drive and scheduled via Buffer

**Buffer Status:** 5/10 scheduled posts (5 slots remaining)
