...
**Produced:** `22_mothman_second_visitor` (Tier 1 folklore/cryptid pivot)

| Field | Value |
|-------|-------|
| **Title** | Point Pleasant Doesn't Talk About the Mothman's Second Visitor |
| **Entity** | Mothman |
| **Tier** | 1 (named folklore/cryptid) |
| **Variant** | B (retrospective-reveal) |
| **Word Count** | 175 |
| **Duration** | 66s |
| **File** | output/FINAL_22_mothman_second_visitor.mp4 (12MB) |
| **Drive URL** | https://drive.google.com/uc?export=download&id=1IdK9inr3PkjDqQeqspsy4T4_ug9GAQRv |
| **Buffer Post ID** | 6ab273ef5cfcad806a3c9606 |
| **Scheduled** | Sep 24, 2026 at 6:00 PM ET (2026-09-24T22:00:00Z) |

**Buffer Queue Status:** 7/10 scheduled (3 slots remaining)

**What Happened:**
- Selected **Mothman** from the folklore database (proven 1,100 view performer)
- Generated story with entity in first sentence, first-hand retelling voice
- Produced voiceover via POYO (ElevenLabs Adam)
- Whisper transcribed 13 segments
- Generated 6 scene images (Gammell style, 9:16)
- Rendered with HyperFrames, mixed with background music
- Initial file was 139MB; Buffer rejected it ("Video could not be read from its URL")
- Re-encoded to 12MB with faststart; Buffer accepted
- Logged variant B in A/B tracker
- Next variant: **A**

**Pivots executed:** This is the first folklore/cryptid short produced since the strategy rewrite. All 6 previously scheduled posts are generic horror (3-240 view range).
