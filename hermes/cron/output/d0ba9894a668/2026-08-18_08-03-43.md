...
## ✅ OptiRFP LinkedIn Post Created

**Image Generated & Verified:**
- **Path:** `/home/herby/.hermes/generated_images/optirfp_ideogram____ID___.png`
- **Headline:** "Specificity wins. Vagueness loses."
- **Topic:** Specificity (magnifying glass visual)
- **Resolution:** 2048x2048
- **Quality Score:** 10/10 ✨

**Post Content Saved as Buffer Idea:**
- **Idea ID:** `6a844a06c6c8a84506e76ba1`
- **Target:** LinkedIn (OptiRFP page)
- **Post Text:**
```
Specificity wins. Vagueness loses.

The #1 reason RFPs lose? Generic responses that could apply to anyone.

Winning proposals use specific examples:
→ "Reduced implementation time by 47%" not "fast implementation"
→ "Saved $2.3M annually" not "significant cost savings"
→ "3-week onboarding" not "quick deployment"

Specificity builds trust. Vagueness signals you have nothing real to say.

#RFP #B2B #ProposalWriting #Sales #BusinessDevelopment
```

**Next Steps:**
1. Open Buffer dashboard → Ideas
2. Find "Specificity wins. Vagueness loses."
3. Attach the generated image from the path above
4. Schedule or post immediately

The image features a clean dark navy background with mint green magnifying glass visualizing the "specificity" concept, with the OptiRFP logo cleanly composited at the bottom.
