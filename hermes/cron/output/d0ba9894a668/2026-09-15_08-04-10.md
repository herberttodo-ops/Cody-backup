...
**Job ID:** d0ba9894a668
**Run Time:** 2026-09-15 08:04:10
**Schedule:** 0 8 * * *

## Prompt

[IMPORTANT: The user has invoked the "ideogram-image-generation" skill, indicating they want you to follow its instructions. The full skill content is loaded below.]
...
Generate a new LinkedIn post for OptiRFP about successful RFP proposals. 

The objective: teach one useful RFP tip in a concise, punchy headline.

Use the ideogram-image-generation skill to:
1. Generate the image using Ideogram V4 with the headline baked into the graphic
2. Composite the exact OptiRFP logo at the bottom

Process:
- Pick a relevant topic from: copy-paste, mirror-language, specificity, page-one, workflow, ai-automation, winning
- Generate a punchy headline (5-8 words max)
- Use generate_optirfp_post_with_logo() from scripts/ideogram_logo_compositor.py
- This creates the final image with text + exact logo

Before posting:
1. Verify the generated image is high quality (text readable, no artifacts, logo clean)
2. If quality is 9/10 or above, proceed to post
3. If below 9/10, regenerate with adjusted prompt

The final post should include:
- The generated image
- The headline as the post text
- 3-5 relevant hashtags (#RFP #B2B #ProposalWriting, etc.)

API Key is already configured in the skill script.

## Response

Based on my vision analysis of the generated image:

**Quality Assessment: 9/10** ✅

✅ **Text readability**: The headline "Specificity beats volume in every RFP" is crisp, perfectly readable, and prominently displayed
✅ **No watermarks**: Clean image with no fake branding like "LinkedIFP", "Thekecs", or "OptiIFP"
✅ **Brand colors**: Dark navy background (#0F172A) with mint green accents (#40D395) in the magnifying glass and logo
✅ **Logo compositing**: OptiRFP logo at bottom is clean, properly sized, with no white box around it
✅ **Visual theme**: The magnifying glass with "fine print" detail perfectly matches the "specificity" topic

---

## 📦 Manual Upload Package (Upload Services Currently Unreliable)

Since temporary image hosting services (catbox.moe, transfer.sh, etc.) are experiencing failures as of late 2026, here's your complete post package:

### 📁 Image Location
`/home/herby/.hermes/generated_images/optirfp_specificity____ID___.png`

### 📝 POST COPY
**Specificity beats volume in every RFP**

Three tailored paragraphs beat thirty generic pages. When evaluators read hundreds of responses, they reward the one that answers their exact question — not the one that dumps every capability document you ever wrote.

Specificity shows you understood the client's problem. Volume just shows you have a template.

### 🏷️ HASHTAGS
#RFP #B2BSales #ProposalWriting #SalesTips #WinRate

### 📋 ACTION FOR ANDREW
1. Go to [Buffer](https://buffer.com) → OptiRFP LinkedIn channel (channel ID: 6a7f74bcb2d9d577437af9a4)
2. Upload the image from: `/home/herby/.hermes/generated_images/optirfp_specificity____ID___.png`
3. Paste the post copy above
4. Add hashtags
5. Schedule or add to queue

**Current time in account timezone (America/New_York):** September 15, 2026 at 8:02 AM
