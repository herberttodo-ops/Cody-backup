...
The image upload service is having issues. Based on the skill documentation for restricted environments, I'll prepare a manual upload package since automated posting is blocked.
...
The evaluators don't care about your process—they care about outcomes. 

Lead with value, not methodology.

### 🏷️ HASHTAGS
#RFP #B2BSales #ProposalWriting #WinRate

---

### 📋 Quality Check Results: 9/10 ✅
- ✅ Headline text perfectly readable and clear
- ✅ No watermarks or fake branding detected  
- ✅ OptiRFP logo cleanly composited at bottom
- ✅ Professional dark navy (#0F172A) with mint green (#40D395) accents
- ✅ Upward trend visualization reinforces the "winning" theme
- ✅ Clean bottom area with proper logo placement

### 📤 Manual Upload Instructions

Since automated Buffer posting requires a public image URL (upload services temporarily unavailable), please:

1. Go to [Buffer](https://buffer.com) → OptiRFP LinkedIn channel
2. Upload the image from: `/home/herby/.hermes/generated_images/optirfp_social____ID___.png`
3. Copy the post text above
4. Add the hashtags
5. Schedule or add to queue

**Image specs:** 1024×1024px, optimized for LinkedIn feed
