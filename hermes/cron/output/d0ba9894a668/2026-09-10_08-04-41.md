...
## ✅ LinkedIn Post Ready for OptiRFP
...
### 📝 Post Copy
Winning proposals answer the exact ask

The #1 mistake in RFP responses? Answering what you THINK they asked instead of what they ACTUALLY asked.

Winning vendors mirror the RFP's language, structure, and priorities—exactly.

Before you write: Read the requirements. Mirror the wording. Address every point.
...
### 🎨 Graphic Details
- **Headline:** "Winning proposals answer the exact ask" (6 words)
- **Topic:** Winning proposals / specificity
- **Visual:** Dark navy background with mint green upward-trending curve visualization
- **Logo:** OptiRFP logo composited cleanly at bottom
- **AI Model:** Ideogram V4

### 📤 Upload Instructions
1. Go to [Buffer](https://buffer.com) → OptiRFP LinkedIn channel
2. Upload image: `/home/herby/.hermes/generated_images/optirfp_social____ID___.png`
3. Copy the post text above
4. Add hashtags
5. Schedule or add to queue

**Note:** Buffer MCP rejected the local file URL (expected behavior in cron environments). Manual upload required.
