...
### 📊 Quality Verification: 9/10 PASSED
| Criteria | Status |
|----------|--------|
| Text readability | ✅ Crystal clear |
| No watermarks | ✅ Clean |
| Brand colors | ✅ Dark navy + mint green |
| Logo placement | ✅ Clean at bottom |
| No artifacts | ✅ None detected |

### 🖼️ Generated Image
**File:** `/home/herby/.hermes/generated_images/optirfp_social____ID___.png`  
**Resolution:** 1024x1024 (Square format for LinkedIn)  
**Headline:** "Features tell. Outcomes sell."

### 📝 Post Copy
```
Features tell. Outcomes sell.

The winning RFPs don't start with what you do—they start with what the client gets.

Buyers are drowning in feature lists. What cuts through? Results.

Before you write your next response, ask: "So what?" If the answer isn't obvious to someone who doesn't know your product, rewrite it.

Your differentiator isn't your feature set. It's the outcome only you can deliver.
```
...
2. Upload the image: `/home/herby/.hermes/generated_images/optirfp_social____ID___.png`
3. Copy the post text above
4. Add to queue or schedule

*Note: Due to cron environment limitations, image hosting services are unreliable. Manual upload ensures the highest quality post delivery.*
