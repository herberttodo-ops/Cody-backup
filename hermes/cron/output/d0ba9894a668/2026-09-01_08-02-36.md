...
Buffer couldn't read the local file URL. Per the skill workflow, I'll provide the manual upload package:
...
### 📁 Generated Image
**Location:** `/home/herby/.hermes/generated_images/optirfp_winning____ID___.png`

### 📝 Post Copy
Winning RFPs mirror the source

The #1 mistake in RFP responses? Generic copy-paste answers.

Winning proposals echo the evaluator's language. When they say "cloud security," don't say "data protection." Mirror their terms, their priorities, their concerns.

Your prospect wrote the RFP with specific outcomes in mind. Show them you were listening.
...
1. Go to [Buffer](https://buffer.com) → OptiRFP LinkedIn channel
2. Upload the image from: `/home/herby/.hermes/generated_images/optirfp_winning____ID___.png`
...
- OptiRFP logo: Clean and properly positioned
- Colors: Professional dark navy with mint accents
