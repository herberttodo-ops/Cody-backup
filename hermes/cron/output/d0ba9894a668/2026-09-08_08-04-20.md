...
All temporary upload services are failing (catbox.moe 500 error, transfer.sh connection refused, file.io 301, 0x0.st disabled). According to the skill's fallback workflow, I'll prepare a manual upload package since automated posting is blocked.
...
### 📁 Image Location
`/home/herby/.hermes/generated_images/optirfp_ideogram____ID___.png`

**Image Details:**
- **Headline:** "Winning proposals lead with outcomes"
...
- ✅ Text is crystal clear and perfectly legible
- ✅ No watermarks or fake branding detected
- ✅ Brand colors correct (dark navy #0F172A with mint #40D395 accents)
- ✅ Professional upward trend visualization
...
Before diving into methodology, credentials, or features, winning RFPs answer the buyer's real question: "So what?"

Lead with the business impact. The "how" comes later.
...
1. Go to [Buffer](https://buffer.com) → OptiRFP LinkedIn channel
2. Upload the image from: `/home/herby/.hermes/generated_images/optirfp_ideogram____ID___.png`
3. Copy the post text above
4. Add the hashtags
5. Schedule or add to queue

---

**Note:** The image was generated using Ideogram V4 API with the headline baked directly into the graphic, then composited with the exact OptiRFP logo at the bottom using the `ideogram_logo_compositor.py` script.
